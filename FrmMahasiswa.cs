...
namespace PerpustakaanAppMVC.View
{
    public partial class FrmMahasiswa : Form
    {
        ...
        {
            FrmEntryMahasiswa frmEntry = new FrmEntryMahasiswa("Tambah Data ahasiswa", controller);
 // mendaftarkan method event handler untuk merespon event OnCreate
        ...
        private void btnCari_Click(object sender, EventArgs e)
        {
            ...
            var filteredMahasiswa = listOfMahasiswa.Where(mhs =>
                mhs.Nama.ToLower().Contains(namaCari)
            ).ToList();

            // Tampilkan hasil pencarian ke ListView
